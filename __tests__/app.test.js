...
test('Test', async ({ page }) => {
    ...
    await expect(page.getByText('Название не должно быть короче двух символов')).toBeVisible();
    ...
    await expect(page.getByText('Статья должна быть не короче 10 символов')).toBeVisible();
    ...
    await expect(page.getByText('Статья с таким названием уже существует')).toBeVisible();
});
